...
console.log('🚀 Starting Boltic SDK Todos API server locally...\n');
...
server.listen(PORT, () => {
  ...
  console.log(`   PATCH  http://localhost:${PORT}/todos/:id`);
  ...
  console.log(`   curl -X POST http://localhost:${PORT}/todos -H "Content-Type: application/json" -d '{"title":"Test todo"}'`);
